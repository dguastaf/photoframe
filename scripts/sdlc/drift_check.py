...
REQUIRED_PATHS = [
    ...
    ".cursor/hooks/before-implementation-edit.sh",
    ".cursor/hooks.json",
    ".cursor/rules/pre-implementation-gates.mdc",
    "scripts/sdlc/changed_paths.py",
    "scripts/sdlc/pre_implementation_gate.py",
    "scripts/sdlc/planning_orchestrator.py",
    "scripts/sdlc/parse_staff_review.py",
    ...
    ".cursor/hooks/after-staff-engineer-planning.sh",
